                	...
                	<!-- masterhead Right Section -->
                    		...
                    		<!-- top navigation -->
                    			<div class="topnavigation">
                               		<ul>
                                  		<button class="btn btn-danger"><li class="first ">&nbsp;</li>
                                    	<li ><a>LOGIN</a></li>
                ...
                <div id="banner">
                         ...
                         <!-- Content Heading -->
                         	<div class="content_heading">
                            	<div class="heading"><h2>SELAMAT DATANG DI SMK TIARA NUSA</h2> </div>
                          
                            </div >
                             <p class="text" >
                                 Website SMK Tiara nusa dibangun untuk sebagai penunjang transparasi informasi dan promosi sekolah.  
                                 <p align="justify">Kami Menyambut baik terbitnya Website SMK Tiara nusa yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. Sebaliknya orangtua dapat mengakses informasi tentang kegiatan akademik dan non akademik putra - puterinya di sekolah ini. Dengan fasilitas ini Siswa dapat mengakses berbagai informasi pembelajaran dan informasi akademik.
                                  <p class="text">KAMI DATANG, KAMI BELAJAR, KAMI PINTAR</p>
                             </p>
                          <div class="clear"></div>
