                              ...
                              <div class="navigation">
                                  <div id="smoothmenu1" class="ddsmoothmenu">
                                      <ul>
                                          ...
                                          <li><a class="selected" href="<?php echo base_url().'berita/page'?>">Berita</a> </li>
                                	...
                                	<li>
                                        ...
                                        <div class="description">
                                            ...
                                            <div class="info">
                                                ...
                                                <span class="lastupdte"> Tanggal:<i><?php echo $tulisan_tanggal;?>/<?php echo $tulisan_bulan;?>/<?php echo $tulisan_tahun;?></i></span> 
