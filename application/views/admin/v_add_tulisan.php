        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
			...
			<textarea id="ckeditor" name="xisi" required></textarea>
              ...
              <input style="width: 50px; text-align: center;" type="number" name="xdate" value="<?php echo date ('d') ?>" readonly>/
              <input style="width: 50px; text-align: center;" type="number" name="xmonth" value="<?php echo date ('m') ?>" readonly>/
              <input style="width: 50px; text-align: center;" type="number" name="xyear" value="<?php echo date ('Y') ?>" readonly>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
